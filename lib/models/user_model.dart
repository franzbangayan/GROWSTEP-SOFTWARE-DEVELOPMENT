...
class UserModel {
  ...
  String? avatarVariantId; // ← NEW DRESS UP
  ...
  UserModel({
    ...
    this.avatarVariantId, // ← NEW DRESS UP
  ...
  Map<String, dynamic> toMap() => {
        ...
        'avatarVariantId': avatarVariantId, // ← NEW DRESS UP
      };
  ...
  factory UserModel.fromMap(Map<String, dynamic> map) => UserModel(
        ...
        avatarVariantId: map['avatarVariantId'], // ← NEW DRESS UP
      );
  ...
  Map<String, dynamic> toSqlMap() => {
        ...
        'avatar_variant_id': avatarVariantId, // ← NEW DRESS UP
      };
  ...
  factory UserModel.fromSqlMap(Map<String, dynamic> row) => UserModel(
        ...
        avatarVariantId: row['avatar_variant_id'] as String?, // ← NEW DRESS UP
      );
  ...
  UserModel copyWith({
    ...
    String? avatarVariantId, // ← NEW DRESS UP
      ...
      UserModel(
        ...
        avatarVariantId: avatarVariantId ?? this.avatarVariantId, // ← NEW DRESS UP
      );
}